...
class Client:
    ...
    def register_client(self):
        ...
        print(f"{self.userId} , {self.userAge} , {self.userDriverLicense}, {self.userEmail}, {self.userPhone} " )
        if self.userId != "" and self.userAge != ""\
                             and self.userDriverLicense != ""\
                             and self.userEmail != ""\
                             and self.userPhone != "":
            self.send_bytes_to_server("register-client " + self.phone_id)
        else:
            print_system_notification("Bad command")
